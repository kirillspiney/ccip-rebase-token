...
contract RebaseToken is ERC20, Ownable, AccessControl {
    ...
    /**
     * calculate the balance for the user uncluding the interest rate that has accumulated since the last time their balance was updated.
    ...
    function balanceOf(address _user) public view override returns (uint256) {
        // get the cuurent principle balance of the user (the number of tokens that have actually been minted to the user)
        // multiply the principle balance by the interest rate that has accumulated in the time since the balance was last updated
        return
    ...
    function _mintAccruedInterest(address _user) internal {
        ...
        // call _mint ti mint the tokens to the user
